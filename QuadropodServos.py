...
class QuadropodServos:
    ...
    """
    StancePosition = ServoInstructions([125, 30, 59], [55, 150, 121],
                                   [55, 150, 121], [125, 30, 59])

    CrouchPosition = ServoInstructions([180, 70, 0], [10, 160, 180],
                                    [0, 110, 180], [170, 20, 0])    

    def __init__(self, restPosition):
        print("Winding Servos...")
        QuadropodServos.StancePosition = restPosition
    ...
    def ApplyAngles(self, newServoInstructions = None):
        ...
        if (limitedServoInstructions.RFAngles is not None):
            ...
            (RFHip.angle, RFKnee.angle, RFAnkle.angle) = newRFAngles
